...
- Manually move emails to other categories if necessary. The system automatically moves the corresponding `.emails_summary.md` as well (as long as no emails remain in the source folder).

...
### Model Naming
During training, the chosen method and mode are automatically appended to the filename (e.g., `email_classifier_xgboost_combined.pkl`) to prevent model confusion.

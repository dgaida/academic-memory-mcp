...
#### Creating an Empty OKF Project

To initialize a new, empty OKF project, run the following command:

```bash
google-okf init okf
```

Afterwards, the directory will look approximately like this:

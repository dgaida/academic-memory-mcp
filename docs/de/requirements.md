...
*   **FA-3.4 (Pfad-Hierarchie):** Archivierte E-Mails müssen automatisch in eine dreistufige Struktur verschoben werden: `Semester / Nachname / (Inbox oder SentItems)`.  
...
*   **FA-8.2 (Tools für Agenten):** Der Server muss folgende Tools für externe Clients (z.B. Claude Desktop) bereitstellen:  

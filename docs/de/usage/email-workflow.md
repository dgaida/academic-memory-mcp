...
- Mails bei Bedarf manuell in andere Kategorien verschieben. Das System verschiebt dabei automatisch auch die zugehörige `.emails_summary.md` (sofern keine E-Mails im Quellordner verbleiben).

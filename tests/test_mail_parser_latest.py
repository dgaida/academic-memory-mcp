...
def test_extract_latest_message_standard():
    """Tests test_extract_latest_message_standard."""
    parser = MailParser()
...
def test_extract_latest_message_reply_below_quote():
    """Tests test_extract_latest_message_reply_below_quote."""
    parser = MailParser()
...
def test_extract_latest_message_with_multiple_quotes():
    """Tests test_extract_latest_message_with_multiple_quotes."""
    parser = MailParser()
...
def test_extract_latest_message_no_fallback_on_clear_marker():
    """Tests test_extract_latest_message_no_fallback_on_clear_marker."""
    parser = MailParser()
    text = """Short reply.
Zitat von daniel.gaida@th-koeln.de:
> Quote"""
...
def test_extract_latest_message_no_fallback_on_quotes():
    """Tests test_extract_latest_message_no_fallback_on_quotes."""
    parser = MailParser()
    text = """Short.
> Quote line 1
> Quote line 2"""

...
def test_extract_latest_message_zitat():
    """Tests test_extract_latest_message_zitat."""
    parser = MailParser()
...
def test_extract_latest_message_am_schrieb():
    """Tests test_extract_latest_message_am_schrieb."""
    parser = MailParser()
...
def test_extract_latest_message_weitergeleitet():
    """Tests test_extract_latest_message_weitergeleitet."""
    parser = MailParser()
...
def test_extract_latest_message_from():
    """Tests test_extract_latest_message_from."""
    parser = MailParser()
...
def test_extract_latest_message_quotes():
    """Tests test_extract_latest_message_quotes."""
    parser = MailParser()
    text = "Neu.\n\n> Quote 1\n> Quote 2"
    result = parser.extract_latest_message(text)
    assert result == "Neu."
...
def test_extract_latest_message_no_marker():
    """Tests test_extract_latest_message_no_marker."""
    parser = MailParser()

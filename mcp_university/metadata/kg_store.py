"""Wissensgraph-Speicherung für TH Köln Daten (Personal, Module, Studiengänge)."""
import logging
import sqlite3
import json
...
class KnowledgeGraphStore:
    """Verwaltet die Wissensgraph-Persistenz für TH Köln Daten."""

    def __init__(self, db_path: Path) -> None:
        """Initialisiert den KnowledgeGraphStore.
